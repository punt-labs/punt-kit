...
banner "punt-kit"
curl -fsSL "$GH/punt-kit/e0dd403/install.sh" | sh

banner "beadle"
curl -fsSL "$GH/beadle/8eb832a/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/be375b6/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/25eaa96/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/fbb0a17/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/ddf25c0/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/e19cc99/install.sh" | sh
