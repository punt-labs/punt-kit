...
banner "punt-kit"
curl -fsSL "$GH/punt-kit/2759eee/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/806e1b0/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/3f2cf59/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/f4a694d/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/2021bc8/install.sh" | sh
