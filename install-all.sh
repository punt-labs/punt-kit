...
banner "punt-kit"
curl -fsSL "$GH/punt-kit/e56f21f/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/2de5c95/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/f78fbcf/install.sh" | sh

banner "tts"
curl -fsSL "$GH/tts/45d1364/install.sh" | sh
