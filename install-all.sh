...
banner "biff"
curl -fsSL "$GH/biff/36e9f65/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/996c44b/install.sh" | sh
...
printf 'CLIs:    punt, biff, quarry, vox\n'
printf 'Plugins: biff, dungeon, prfaq, punt, quarry, vox, z-spec\n\n'
