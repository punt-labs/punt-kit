...
banner "punt-kit"
curl -fsSL "$GH/punt-kit/32264f5/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/2842623/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/7275801/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/7a94962/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/ab155d9/install.sh" | sh
