...
The command was reintroduced in v0.16.0 (#327) without an ADR superseding this
decision, then removed again on 2026-09-20 — reaffirming this ruling. The
`.cursor/` **editor**-state gitignore entry is retained (as this ADR always
intended); only the generator command and its documentation are gone. Historical
CHANGELOG and ADR records of both removals stay as-is.
